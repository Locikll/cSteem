...
export const APP_NAME = 'Curie Steem';
// sometimes APP_NAME is written in non-latin characters, but they are needed for technical purposes
// ie. "Голос" > "Golos"
export const APP_NAME_LATIN = 'Curie Steem';
export const APP_NAME_UPPERCASE = 'CURIE STEEM';
export const APP_ICON = 'curie';
// FIXME figure out best way to do this on both client and server from env
// vars. client should read $STM_Config, server should read config package.
export const APP_DOMAIN = 'curiesteem.com';
...
export const LANDING_PAGE_URL = 'https://curiesteem.com/';
export const TERMS_OF_SERVICE_URL = 'https://' + APP_DOMAIN + '/tos.html';
export const PRIVACY_POLICY_URL = 'https://' + APP_DOMAIN + '/privacy.html';
export const WHITEPAPER_URL = 'https://curiesteem.com/assets/pdf/whitepaper.pdf';
...
// meta info
export const TWITTER_HANDLE = '@curiesteem';
