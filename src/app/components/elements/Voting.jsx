...
/*
        if (flag) {
            const down = (
                <Icon
                    name={
                        votingDownActive ? 'empty' : 'chevron-down-circle'
                    }
                />
            );
            const classDown =
        ...
        if (
           ...
           // console.log(JSON.stringify(this.state));
            ...
            dropdown = (
                <FoundationDropdown
                    show={this.state.voteup && showWeight}
                    onHide={() => this.setState({ showWeight: false })}
                >
                ...
                <span className="Voting__inner">
                    ...
                    <span className={classDown}>
                        ...
                        {votingDownActive ? (
                            ...
                            <a 
                                href="#" 
                                onClick={voteDownClick} 
                                title={
                                    myVote < 0
                                        ? tt('g.remove_downvote')
                                        : tt('g.downvote')
                                }
                            >
                                {down}
